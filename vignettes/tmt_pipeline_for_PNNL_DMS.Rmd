...
con_str <- "DRIVER={FreeXXXTDS};SERVER=gigasax;DATABASE=dms5;PORT=1433;UID=dmsreader;PWD=dms4fun"
con_str <- "DRIVER={};SERVER=gigasax;DATABASE=dms5;PORT=1433;UID=dmsreader;PWD=dms4fun"
library(RODBC)
con <- odbcDriverConnect(con_str)

library(odbc)
con_str <- "SERVER=gigasax;DATABASE=dms5;PORT=1433;UID=dmsreader;PWD=dms4fun"
